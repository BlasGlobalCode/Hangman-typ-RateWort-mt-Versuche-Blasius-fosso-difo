...
namespace GuessTheWord
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void WoerterlisteErstellen()
        {
            ...
            Woerterliste.Add("Adgrf");
            Woerterliste.Add("Neavb");
            Woerterliste.Add("fvdfn");
            Woerterliste.Add("Jfdffa");
            Woerterliste.Add("Luca");
            Woerterliste.Add("Chfvdftobfgh");
            Woerterliste.Add("Bfvdbs");
            Woerterliste.Add("Afbbdfbna");
            Woerterliste.Add("Njkuzzti");
            Woerterliste.Add("Ehgmmas");
            Woerterliste.Add("hmmzuurs");
            Woerterliste.Add("Pvbx");
            Woerterliste.Add("Dnbfgntl");
            Woerterliste.Add("ohigfhnr");
            Woerterliste.Add("Swews");
            Woerterliste.Add("Mgvvt");
            Woerterliste.Add("Wojciech");
            Woerterliste.Add("nmgh");
            Woerterliste.Add("qwecdsrg");
        }
